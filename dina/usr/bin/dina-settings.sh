...
TITLE="Dina Settings"
ICON="dina-browser"
EXTENSIONS=$(yad --width=50 --center --window-icon="$ICON" --borders 15 --name="${0##*/}" --title="$TITLE" --image="settings" --form --field="  Extend Dina:CB" Terminal\!More-coming-soon..)
